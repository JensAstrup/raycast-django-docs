import { DJANGO_DOCS_BASE_URL, SITEMAP_URL, getUrlPatternsForVersion, DJANGO_VERSIONS, DjangoVersion } from '../constants';
...
describe('constants', () => {
  ...
  describe('DJANGO_VERSIONS', () => {
    ...
    it('should contain expected version strings', () => {
      expect(DJANGO_VERSIONS).toEqual(['6.0', 'dev', '5.2', '5.1', '5.0', '4.2']);
    });
  ...
  describe('DjangoVersion type', () => {
    it('should accept valid Django version strings', () => {
      ...
      expect([version1, version2, version3, version4, version5, version6]).toEqual(['6.0', 'dev', '5.2', '5.1', '5.0', '4.2']);
    });
  });
});
